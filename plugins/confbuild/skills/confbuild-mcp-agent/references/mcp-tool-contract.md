...
- Hosted Remote MCP: private render job completed only by the matching open project in the user's signed-in browser tab; the bridge never opens or navigates a tab.
